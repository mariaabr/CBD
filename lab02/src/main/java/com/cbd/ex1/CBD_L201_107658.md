...
Este método aceita um documento contendo uma lista de campos juntamente com a sua ordem. A ordem é especificada pelos valores 1 e -1. O valor 1 representa a ordem ascendente e o valor -1 representa a ordem descendente.
